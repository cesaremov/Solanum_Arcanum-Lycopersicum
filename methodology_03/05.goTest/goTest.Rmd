...
trinotateTab <- read.table(file = "../00.Trinity_Trinotate/04.Trinotate/Trinotate.xls",
                           sep = "\t",
...
goList <- goList[goLen > quantile(goLen, 0.85) & goLen < quantile(goLen, 0.999)]
print(length(goList))
goLen <- sapply(goList, length)
...
save(ontScoreMatList, file = "02_ontMatList.Rdata")
```
